...
class Game:
   ...
   def draw(self):
      ...
      self.small_dot.draw()
      self.big_dot.draw()
      pygame.display.update() # make the updated surface appear on the display. Since no arguments is passed, it updates the entire Surface area like pygame.display.flip() 
